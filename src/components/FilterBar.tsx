...
export function FilterBar({
  ...
  return (
    <div className="mb-4 sm:mb-6 glass-strong rounded-2xl p-4 sm:p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
        <div>
          ...
          <select
            ...
            className="w-full px-3 sm:px-4 py-2 sm:py-2.5 text-sm glass rounded-xl focus:outline-none focus:ring-2 focus:ring-[#1552F0]/50 transition-all text-black bg-white/50"
          >
