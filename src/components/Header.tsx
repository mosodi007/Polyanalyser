      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <button className="flex items-center gap-2 px-4 sm:px-6 py-2 sm:py-2.5 bg-[#1552F0] hover:bg-[#0f3ec4] text-white rounded-3xl transition-all shadow-md border-2 border-[#000]">
