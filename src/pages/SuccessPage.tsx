...
export function SuccessPage() {
  ...
  useEffect(() => {
    // Refresh subscription state to get latest data
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8 text-center">
        ...
        <div className="space-y-4">
          <Link
            to="/"
            className="w-full flex justify-center items-center py-3 px-6 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-[#1552F0] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
          >
